...
const conferences: Record<Locale, Conference>[] = [
  {
    en: {
      ...
      hero: {
        alt: '',
        image: {
          mobile: '/2024/en/hero-mobile.jpg',
          desktop: '/2024/en/hero-desktop.jpg',
        },
      },
      dates: [
  ...
  },
  {
    en: {
      ...
      hero: {
        alt: '',
        image: {
          mobile: '/2025/en/hero-desktop.jpg',
          desktop: '/2025/en/hero-desktop.jpg',
        },
      },
      dates: [
    ...
    fr: {
      ...
      hero: {
        alt: '',
        image: {
          mobile: '/2025/fr/hero-desktop.jpg',
          desktop: '/2025/fr/hero-desktop.jpg',
        },
      },
      dates: [
        dayjs('2025-08-20').utcOffset(EST_OFFSET).endOf('day').valueOf(),
...
export const getCurrentConference = (locale: Locale): Conference => {
  ...
  const now = dayjs();
  let currentConferenceIndex = conferences.findIndex((conference) =>
    now.isBefore(conference[locale].dates[0]),
  );
