...
const en = {
  ...
  'team.position.vp-marketing': 'VP Marketing',
  'team.position.vp-production': 'VP Production',
...
const fr: Record<TranslationKey, string> = {
  ...
  'team.position.vp-marketing': 'Vice-président du marketing',
  'team.position.vp-production': 'Vice-président de la production',
