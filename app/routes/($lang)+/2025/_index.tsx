...
export const meta: MetaFunction = ({ params }) => {
  ...
  if (locale === 'fr') {
    return [
      { title: '2025 Inscription | GYCC' },
      { name: 'description', content: 'Inscrivez-vous à la conférence 2025.' },
    ];
  }

  return [
    { title: '2025 Registration | GYCC' },
    { name: 'description', content: 'Register for the 2025 conference.' },
  ];
};
